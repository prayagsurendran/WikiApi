...
def pathList():
  ...
  path.update({'checkDisambiguationById': 'finalDataSets/pageDataSets/disambiguation/checkDisambiguationById/'})	#not using
  ...
  path.update({'getInlinkListById': 'finalDataSets/pageDataSets/inlinks/getInlinkListById/'})	
  path.update({'getInlinkListByTitle': 'finalDataSets/pageDataSets/inlinks/getInlinkListByTitle/'})
  ...
  path.update({'getOutlinkListById': 'finalDataSets/pageDataSets/outlinks/getOutlinkListById/'})	
  path.update({'getOutlinkListByTitle': 'finalDataSets/pageDataSets/outlinks/getOutlinkListByTitle/'})
...
def fileDivider(file, path):
  ...
  if os.path.isfile(filename):
    print "Dividing %s to chungs..."%(filename)
